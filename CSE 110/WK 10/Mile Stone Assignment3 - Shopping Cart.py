...
def remove_item():
    if not names:
        ...
        return
    display_cart()
    item_num = int(input("Which item would you like to remove? (Enter 0 to cancel): "))
    if item_num == 0:
...
while True:
    ...
    Items displayed when removing an item and a feature that prompts the user to enter the quantity of an item they want to remove or input "0" to cancel
        ...
        Shows Empty when Cart is empty.
    """