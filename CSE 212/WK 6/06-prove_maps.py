...
class Maze:
    ...
    def move_left(self):
        ...
        """
        if self.maze_map.get((self.curr_x, self.curr_y))[0]:
            self.curr_y -= 1
        else:
    ...
    def move_right(self):
        ...
        can't move, then display "Can't go that way!"
        """        
        if self.maze_map.get((self.curr_x, self.curr_y))[1]:
            self.curr_y += 1
        else:
            print("Can't go that way!")
    ...
    def move_up(self):
        ...
        can't move, then display "Can't go that way!"
        """
        if self.maze_map.get((self.curr_x, self.curr_y))[2]:
            self.curr_x -= 1
        else:
            print("Can't go that way!")
    ...
    def move_down(self):
        ...
        can't move, then display "Can't go that way!"
        """
        if self.maze_map.get((self.curr_x, self.curr_y))[3]:
            self.curr_x += 1
        else:
            print("Can't go that way!")
